...
def main() -> int:
    ...
    try:
        ...
        require("encryptedStateVersion" in service_worker, "service worker nie szyfruje stanu przypomnień")
        require("crypto.subtle.encrypt" in service_worker, "service worker nie używa Web Crypto do zapisu")
        require("crypto.subtle.decrypt" in service_worker, "service worker nie uwierzytelnia odczytu")
